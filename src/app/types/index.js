export const POSTS_PARAMS_CHANGED = 'connection/POSTS_PARAMS_CHANGED';
export const PAGES_PARAMS_CHANGED = 'connection/PAGES_PARAMS_CHANGED';
export const TAGS_PARAMS_CHANGED = 'connection/TAGS_PARAMS_CHANGED';
export const USERS_PARAMS_CHANGED = 'connection/USERS_PARAMS_CHANGED';
export const MEDIA_PARAMS_CHANGED = 'connection/MEDIA_PARAMS_CHANGED';
export const CATEGORIES_PARAMS_CHANGED = 'connection/CATEGORIES_PARAMS_CHANGED';
export const COMMENTS_PARAMS_CHANGED = 'connection/COMMENTS_PARAMS_CHANGED';
export const TAXONOMIES_PARAMS_CHANGED = 'connection/TAXONOMIES_PARAMS_CHANGED';
export const POST_TYPES_PARAMS_CHANGED = 'connection/POST_TYPES_PARAMS_CHANGED';
export const POST_STATUSES_PARAMS_CHANGED = 'connection/POST_STATUSES_PARAMS_CHANGED';
